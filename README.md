...
I am collaborating with [Cornell ICPC](https://www.cs.cornell.edu/acm/) and [Millennium](https://www.mlp.com/) to build **efficient LLMs for code and data generation in interactive environments**.
